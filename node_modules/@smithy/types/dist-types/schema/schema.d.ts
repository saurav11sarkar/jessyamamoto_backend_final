import type { EndpointV2 } from "@smithy/types/dist-types/endpoint";
import type { HandlerExecutionContext } from "@smithy/types/dist-types/middleware";
import type { MetadataBearer } from "@smithy/types/dist-types/response";
import type { EndpointBearer, SerdeFunctions } from "@smithy/types/dist-types/serde";
import type { BigDecimalSchema, BigIntegerSchema, BlobSchema, BooleanSchema, DocumentSchema, NumericSchema, StreamingBlobSchema, StringSchema, TimestampDateTimeSchema, TimestampDefaultSchema, TimestampEpochSecondsSchema, TimestampHttpDateSchema } from "@smithy/types/dist-types/schema/sentinels";
import type { TraitBitVector } from "@smithy/types/dist-types/schema/traits";
/**
